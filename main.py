...
#-------------------------
Label(win,text ="COLLEGE OF ENGINEERING",font = ("Times New Roman",22),fg='red',bg='#17141D').place(x=345,y=0)
Label(win,text ="STUDENT DATABASE",font = ("Times New Roman",22),fg='white',bg='#17141D').place(x=390,y=100)
#-------------------------
...
name=Entry(t1,width=50,borderwidth=0.5)
...
rollno=Entry(t1,width=50,borderwidth=0.5)
...
address=Entry(t1,width=50,borderwidth=0.5)
...
phoneno=Entry(t1,width=50,borderwidth=0.5)
